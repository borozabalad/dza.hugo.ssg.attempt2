    ...
    -   [TtDT - Report - Appendices]({{< ref "page5768675336.md" >}})
        ...
        -   [TtDT - Report - Appendix - Reference
            ...
            -   [TtDT - Report - Appendix - Reference Iconography -
                ...
                -   TtDT - Report - Appendix - Reference Iconography -
                    Report - Pipeline architecture \_ archive 30/01/23
...
::: table-wrap
  ...
  **objects**     **iconography objects**                                                                                                                                      **iconography object names**   **notes**   **iconography objects adorned with ...**   **iconography objects adorning ...**
  encapsulation   [![](/img_180.png){.confluence-embedded-image .image-center}]{.confluence-embedded-file-wrapper .image-center-wrapper}   encapsulation                                                                         
  sub-pipeline    [![](/img_181.png){.confluence-embedded-image .image-center}]{.confluence-embedded-file-wrapper .image-center-wrapper}   sub-pipeline                                                                          
  --------------- ------------------------------------------------------------------------------------------------------------------------------------------------------------ ------------------------------ ----------- ------------------------------------------ --------------------------------------
:::
