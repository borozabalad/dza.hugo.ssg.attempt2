...
::: table-wrap
  ...
  **Icons**                                                                                                                                                    **Icon names**   **Notes**
  [![](/img_133.png){.confluence-embedded-image .image-center}]{.confluence-embedded-file-wrapper .image-center-wrapper}   pipe             
  [![](/img_134.png){.confluence-embedded-image .image-center}]{.confluence-embedded-file-wrapper .image-center-wrapper}   pipe             pipe icon adorned with the dataset collection icon
  [![](/img_135.png){.confluence-embedded-image .image-center}]{.confluence-embedded-file-wrapper .image-center-wrapper}   pipe             pipe icon adorned with the dataset icon
  [![](/img_136.png){.confluence-embedded-image .image-center}]{.confluence-embedded-file-wrapper .image-center-wrapper}   start pipe       pipe icon adorned with the data source icon
  [![](/img_137.png){.confluence-embedded-image .image-center}]{.confluence-embedded-file-wrapper .image-center-wrapper}   end pipe         pipe icon adorned with the data target icon
  [![](/img_138.png){.confluence-embedded-image .image-center}]{.confluence-embedded-file-wrapper .image-center-wrapper}   gate             
  [![](/img_139.png){.confluence-embedded-image .image-center}]{.confluence-embedded-file-wrapper .image-center-wrapper}   gate             gate icon adorned with the dataset collection icon
  ------------------------------------------------------------------------------------------------------------------------------------------------------------ ---------------- ----------------------------------------------------
:::
...
::: table-wrap
  ------------------------------------------------------------------------------------------------------------------------------------------------------------ ------------------------------- ----------------------------------------------------
  **Icons**                                                                                                                                                    **Icon names**                  **Notes**
  [![](/img_140.png){.confluence-embedded-image .image-center}]{.confluence-embedded-file-wrapper .image-center-wrapper}   filter, also known as process   AGu - add bCLEARer palette?
  [![](/img_141.png){.confluence-embedded-image .image-center}]{.confluence-embedded-file-wrapper .image-center-wrapper}   filter                          
  [![](/img_142.png){.confluence-embedded-image .image-center}]{.confluence-embedded-file-wrapper .image-center-wrapper}   manual                          this icon adorns filters requiring a manual action
  ------------------------------------------------------------------------------------------------------------------------------------------------------------ ------------------------------- ----------------------------------------------------
:::
...
::: table-wrap
  ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- ------------------- --------------------------------------------------------------------------------------------------
  **Icons**                                                                                                                                                                                                              **Icon names**      **Notes**
  [![](/img_151.png){.confluence-embedded-image .image-center width="102" height="314"}]{.confluence-embedded-file-wrapper .image-center-wrapper .confluence-embedded-manual-size}   evolutionary time   
  [![](/img_152.png){.confluence-embedded-image .image-center}]{.confluence-embedded-file-wrapper .image-center-wrapper}                                                             evolution stage     [AGu: this is not an axis, but can it sit in the axis section?]{style="color: rgb(76,154,255);"}
  [![](/img_153.png){.confluence-embedded-image .image-center}]{.confluence-embedded-file-wrapper .image-center-wrapper}                                                             process time        
  ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- ------------------- --------------------------------------------------------------------------------------------------
:::
